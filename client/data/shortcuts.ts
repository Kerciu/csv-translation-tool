...
const shortcuts: Shortcut[] = [
  ...
  },
  {
    ...
    description:
      'Click on a row number, then Shift+Click on another row to select all rows in between',
  },
  {
    action: 'Select/deselect multiple rows',
    shortcut: 'Ctrl/Cmd + Click',
    description:
      'Hold Ctrl (Windows) or Cmd (Mac) and click on row numbers to select or deselect multiple rows',
  },
  {
