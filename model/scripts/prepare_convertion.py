...
if __name__ == "__main__":
    ...
    src_tokenizer = os.path.join(models_dir, f"tokenizer-marian-base-{src_lang}-{tgt_lang}.json")
    tgt_tokenizer = os.path.join(models_dir, f"tokenizer-marian-base-{tgt_lang}-{src_lang}.json")
